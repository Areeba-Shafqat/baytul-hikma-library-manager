...
if st.session_state.current_view == "add_book":
    ...
    with st.form(key='add_book_form'):
        ...
        with col2:
            genre = st.selectbox("Genre", ["Fiction", "Non-Fiction", "Science", "Technology", "Fantasy", "Philosopy","Religion","Other"])
    ...
    st.markdown("<h2 class='sub-header'>Library Collection</h2>", unsafe_allow_html=True)
